...
function getTutorialText(page) {
  if (page == 0) {
    ...
    return "[Making a Request]\n\n".bold() + 
            "You are given 8 credits to begin with " + 
    ...
    return "[Viewing & Taking Active Requests]\n\n".bold() + 
           ...
           "you can view it in /view. You can also take (accept another user's request) " + 
           "any requests that are active in /view.";
  } else if (page == 3) {
    ...
    return "[Profile & Leaderboard]\n\n".bold() + 
           ...
           "that can be accessed through /leaderboard. Prizes and Welfare may be offered to Eusoffians " + 
    ...
    return "[Final Words]\n\n".bold() + 
           ...
           "If you want to unregister from the bot and remove your details from the system, click /unregister";
  }
}